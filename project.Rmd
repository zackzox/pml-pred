...
---
<style type="text/css">
body, td { font-size: 16px;  font-family: Times;}
code.r   { font-size: 11px; }
pre      { font-size: 10px; font-family: 'DejaVu Sans Mono', 'Droid Sans Mono', 'Lucida Console', Consolas, Monaco, monospace;}
pre code { font-size: 10px; font-family: 'DejaVu Sans Mono', 'Droid Sans Mono', 'Lucida Console', Consolas, Monaco, monospace;}
code     { font-size: 16px;   font-family: Times; }

h1 {  margin: 24pt 0pt 0pt 0pt; font-size: 14pt;  color: #365F91;  }
h2 {  font-size: 13pt;color: #4F81BD; }
h3 {  font-size: 11pt;color: #4F81BD;}
</style>
...
We have a `r round(z$overall[1],3)` accuracy rate for the validation set. So we are confident with the model built.
